...
def setup():
    size(1000, 1000)
    rect(20, 20, 200, 200)
    radii = [40, 40, 40, 20, 20, 30, 30, 30, 30, 40, 40, 40, 40]
    ...
    noFill()
    translate(4, 10)
    arc_augmented_poly(p_list, r_list, arc_func=p_arc, num_points=10)
    arc_filleted_poly(p_list, r_list, arc_func=p_arc, num_points=10)
