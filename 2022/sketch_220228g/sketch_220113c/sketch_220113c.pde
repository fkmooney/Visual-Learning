...
int particelNum = 40000, speed = 800;  //generally between 10000 and 50000
...
float thr = 0.85; // generally between .70 and .99 is good               
int max_length = 120; // 200 = very short lines, 1 = no restrictions     
